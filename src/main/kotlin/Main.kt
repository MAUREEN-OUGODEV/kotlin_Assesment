...
fun inputPassword(password:Any):Boolean{
...
class SavingsAccount(accountnumber:String,accountname:String,balance:Double,var withdrawals:Int):CurrentAccount(accountname,accountnumber,balance){
